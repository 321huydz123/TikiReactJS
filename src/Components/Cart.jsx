                ...
                <div className='w-[28%]  h-102  p-2  items-center shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] rounded-lg'>
                    <div className='mx-4 my-4'>
                        ...
                        <div className='flex justify-between items-center'>
                            ...
                            <span className='text-red-600 text-xl font-bold' >{formattedNumber((parseInt(totalAfterVat)))} đ</span>
                        </div>
                        {itemAmount === 0 && (
                        ...
                        {itemAmount > 0 && (
                            <Link to='/checkout' className='px-20 text-2xl py-6 flex justify-center items-center mt-10 bg-red-600  text-white font-bold rounded-xl'>
                                <span> Thanh toán</span>
                            </Link>
                        )}
                    </div>
